...
<style type="text/css">
  ...
  .System_status_section1 .box ul::-webkit-scrollbar {
      width: 0.7em;
      height: 0.7em
  }
  .System_status_section1 .box ul::-webkit-scrollbar-button {
      background: #c5c5c5
  }
  .System_status_section1 .box ul::-webkit-scrollbar-track-piece {
      background: #dfdfdf
  }
  .System_status_section1 .box ul::-webkit-scrollbar-track {
      background: white
  }
  .System_status_section1 .box ul::-webkit-scrollbar-thumb {
      background: #a3a3a3;
      border-radius: 4px;
  }
</style>  
